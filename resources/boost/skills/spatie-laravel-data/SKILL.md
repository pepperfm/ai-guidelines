...
**Актуальная версия (проверено):** v4.19.1
...
**Когда использовать**
- Когда есть потребность создать FormRequest класс
- Когда есть потребность типизировать ответ: создать Response для контроллера
- Когда нужно просто типизировать какую-то сущность
